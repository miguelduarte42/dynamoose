...
function Attribute(schema, name, value) {
    ...
    if (this.encrypt) {
        debug('Overwriting attribute %s type to string', name);
        this.originalType = this.getType(value);
        value.type = String;
    }
    ...
    if (!schema.useDocumentTypes) {
        ...
        this.originalType = convertToDocumentTypes(this.originalType);
    }
    ...
    if(this.encrypt)
        this.originalAttributes = setupAttributes(this.originalType, value, schema);

    this.attributes = setupAttributes(this.type, value, schema);
...
function setupAttributes(type, value, schema) {
